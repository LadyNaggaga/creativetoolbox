"""Smoke-test the deployed Squad Room toolbox (Tool Search on).

Usage:
    python toolbox_test.py "<TOOLBOX_ENDPOINT>" "how is theming done in this codebase"
...
TB = sys.argv[1]
QUERY = sys.argv[2] if len(sys.argv) > 2 else "how is theming done in this codebase"
