#!/usr/bin/env python3
"""
Local Toolbox + Tool Search emulator.
...
This mirrors the shape of the real Foundry Toolbox MCP endpoint closely enough that the agent code
...
if __name__ == "__main__":
    ...
    print(f"listening on http://localhost:{PORT}/toolboxes/squad-room/mcp")
