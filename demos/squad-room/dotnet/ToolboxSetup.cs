// --real mode: create the actual Foundry Toolbox version with Tool Search enabled.
...
//             serverLabel: "squad-room".Replace("-", ""),
...
//             toolboxName: "squad-room",
//             tools: [searchPreview, mcp],
//             description: "The Squad Room — built by toolbox-demo-builder, tool search enabled");
//
//         Console.WriteLine($"created toolbox '{v.Name}' version {v.Version}");
//         Console.WriteLine($"consumer endpoint: {endpoint}/toolboxes/squad-room/mcp?api-version=v1");
//     }
// }
//
