// Mars Greenhouse Ops — hero-tools MCP server on Azure Container Apps.
...
param appName string = 'marsgreenhouse-mcp'

@description('Existing Azure Container Registry name that holds the built image.')
param acrName string

@description('Fully-qualified container image, e.g. myacr.azurecr.io/marsgreenhouse-mcp:latest')
